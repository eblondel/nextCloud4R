...
#' @docType class
#' @export
#' @keywords nextcloud request
#' @return Object of \code{\link{R6Class}} for modelling a generic 'nextCloud' web-service request
#' @format \code{\link{R6Class}} object.
#'
#' @section Methods:
#' \describe{
#'  \item{\code{new(type, url, request, user, pwd, logger)}}{
#'    This method is used to instantiate a object for doing an 'nextCloud' web-service request
#'  }
...
#' }
#' 
#' @note Abstract class used internally by \pkg{nextCloud4R}
#' 
#' @author Emmanuel Blondel <emmanuel.blondel1@@gmail.com>
#'
nextCloudRequest <- R6Class("nextCloudRequest",
  ...
  private = list(
    ...
    getUserAgent = function(){
      return(paste("nextCloud4R", packageVersion("nextCloud4R"), sep="-"))
    },
